...
function mil_problem_notification (type)
{
	...
	if (type === "problem")
	{
		mil_problem_notification_box_title = "Notify a problem"; //"Signaler un problème";
	}
	else if (type === "abuse")
	{
		mil_problem_notification_box_title = "Report abuse";
	}
...
(function () {
	var browserMessage = "Your browser is:";	 // You are using...
	...
	if (BrowserDetect.browser === "Chrome")
	{
		...
		{
			browserMessage += "This version is already old and can cause navigation problems. You should do an update and or use another up-to-date browser.";
...
* 		url param.
* 		- In the mil_ system, it could be something like: "1001_addon/assets/templates/common/js/server_script.ajax.php"
...
function mil_ajax (params)
{
	...
	function error (jqXHR, textStatus, errorThrown)
	{
		...
		alert ("An error has occurred and the server does not respond. The webmaster has been informed, and will correct the problem. Please accept our apologies and try again later.");
		config.error ();
